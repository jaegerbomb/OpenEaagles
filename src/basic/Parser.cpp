...
{
      16,     0,    -1,    18,    -1,     4,    18,    -1,    -1,    17,
      18,    -1,    17,    20,    -1,    17,    19,    -1,     9,     3,
      17,    10,    -1,    11,    17,    12,    -1,     4,    20,    -1,
       4,    18,    -1,     8,    -1,     3,    -1,     7,    -1,    13,
      21,    14,    -1,    22,    -1,    22,    -1,    21,    22,    -1,
       5,    -1,     6,    -1
};
...
{
       0,   153,   153,   154,   157,   159,   171,   182,   186,   188,
     192,   193,   196,   197,   198,   199,   200,   203,   204,   207,
     208
};
#endif
...
static const char *const yytname[] =
{
  ...
  "slot_value", "prim", "numlist", "number", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 182 "Parser.y"
    { (yyvsp[(1) - (2)].svalp)->put((yyvsp[(2) - (2)].pvalp)); (yyvsp[(2) - (2)].pvalp)->unref(); (yyval.svalp) = (yyvsp[(1) - (2)].svalp); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 186 "Parser.y"
    { (yyval.ovalp) = gufParse((yyvsp[(2) - (4)].cvalp), (yyvsp[(3) - (4)].svalp)); delete[] (yyvsp[(2) - (4)].cvalp); (yyvsp[(3) - (4)].svalp)->unref(); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 204 "Parser.y"
    { (yyval.lvalp) = (yyvsp[(1) - (2)].lvalp); (yyval.lvalp)->put((yyvsp[(2) - (2)].nvalp)); (yyvsp[(2) - (2)].nvalp)->unref(); ;}
    break;
